...
def main_worker(gpu, ngpus_per_node, args):
    ...
    final_model_name = 'simsiam{}_b{}_s{}_g{}_w{}_p{}'.format(args.method,args.big,(args.sample_rate),(args.generative),args.recon_weight,args.predictor)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train(train_loader, model, criterion, optimizer, epoch, args,log_path)
...
def train(train_loader, model, criterion, optimizer, epoch, args,log_path):
    ...
    if args.generative:
        ...
        len(train_loader),
        [batch_time, data_time, all_losses, losses, losses_recon1, losses_recon2],log_path,
        prefix="Epoch: [{}]".format(epoch))
    progress = ProgressMeter(
        len(train_loader),
        [batch_time, data_time, losses],log_path,
        prefix="Epoch: [{}]".format(epoch))
